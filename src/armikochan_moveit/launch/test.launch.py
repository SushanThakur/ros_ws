...
def generate_launch_description():
    moveit_config = (
        MoveItConfigsBuilder("armikochan_moveit", package_name="armikochan_moveit")
        .robot_description(file_path="config/urdf_viz.urdf.xacro")
    ...
    container = launch_ros.actions.ComposableNodeContainer(
        ...
        composable_node_descriptions=[
            ...
            launch_ros.descriptions.ComposableNode(
                ...
                parameters=[{"child_frame_id": "/base_link", "frame_id": "map"}],
            ),
        ],
        output="screen",
    )

...
def generate_launch_description():
    ...
    servo_params = {
        "moveit_servo": ParameterBuilder("test_armikochan")
    ...
    moveit_config = (
        MoveItConfigsBuilder("custom_robot", package_name="test_armikochan")
        .robot_description(
    ...
    rviz_config = os.path.join(
        get_package_share_directory("test_armikochan"),
        "config",
        "moveit.rviz",
    )
    rviz_node = Node(

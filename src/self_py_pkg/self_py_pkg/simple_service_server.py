...
from robotic_arm_msgs.srv import AddTwoInts
...
# ros2 run self_py_pkg simple_service_server

# ros2 service list

# ros2 service type /add_two_ints

# ros2 service call /add_two_ints robotic_arm_msgs/src/AddTwoInts "a:10 b:8"